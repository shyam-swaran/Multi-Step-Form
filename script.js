...
function nextForm(){
    switch(slideCount){
        ...
        case 1: checkValidation2();break;
        case 2:checkValidation3();break;
        case 3:thankyou();break;
    }
}
...
function goBack(){
    slidevalue+=sf.offsetWidth*2;
    slideCount--;
    changeslide();
}
function changeslide(){
    slideCount++;
    slidevalue-=sf.offsetWidth;
    slide.style.transform=`translateX(${slidevalue}px)`;
    for(let i of fnum){
        i.style="";
        if(i.innerText==(slideCount+1)){
